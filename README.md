...
| [`grunt`](https://chrome100.dev/board/grunt)     | yes<sup>[3]</sup> | yes<sup>[4]</sup> | no       | yes       | yes         | yes      | yes       | yes      |
...
<sup>3. lightdm or X11 has issues with drawing the frame on the VT</sup><br>
<sup>4. wifi drivers are missing for BARLA (download & compile at [https://github.com/tomaspinho/rtl8821ce](https://github.com/tomaspinho/rtl8821ce))</sup>
